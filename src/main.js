...
var speed = 0.0336;
var speed_wall = 0.045;
var base_speed = 0.0336;
var base_speed_wall = 0.045;
var speed_increase_rate = 0.02;
var then = 0;
var flash_time = 0;
var flash_then = 0;
var toggle_1 = 0;
...
function main() {
  ...
  function render(now) {
    ...
    if (!game_over && !finish && game_start && objects[0]) {
      var distance = objects[0].distance || 0;
    ...
    var rand = getRandomInt(1, 180); // Reduced from 200 for more frequent spawns
